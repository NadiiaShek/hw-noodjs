...
const verifyControlers = require("../../controlers/verification/index");

const userMiddlevare = require("../../middlewares/userMiddlevare");
const { avatarsMiddleware } = require("../../middlewares/avatarsMiddleware");
const { verifyMiddlevare } = require("../../middlewares/verifyMiddlevare");
const {
...
router.post("/verify", verifyMiddlevare, verifyControlers.verify);

router.get("/verify/:verificationToken", verifyControlers.regVerification);
